                        ...
                        <div class="subject-card-new h-100">
                            <div class="d-flex align-items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="small text-muted mb-0">Grade
                                        <?php echo $grade; ?> Textbook
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="subject-card-new h-100" style="border-top: 4px solid <?php echo $color; ?>;">
                            <div class="d-flex align-items-start gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="small text-muted mb-0">Teacher's Guide — Grade
                                        <?php echo $grade; ?>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="subject-card-new p-0 overflow-hidden h-100">
                            ...
                            <div class="p-4">
                                <h6 class="fw-bold mb-1 text-dark">
                                    <?php echo $subj; ?> Video Lessons
                                </h6>
                                <p class="small text-muted mb-3">Grade
                                    <?php echo $grade; ?> — Official Curriculum
                                </p>
