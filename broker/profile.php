...
<head>
    ...
    <title>Edit Profile - Broker Dashboard</title>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <form method="POST">
                                ...
                                <div class="mb-3"><label class="form-label">Current</label><input type="password"
                                        name="current_password" class="form-control" required></div>
                                <div class="mb-3"><label class="form-label">New</label><input type="password"
