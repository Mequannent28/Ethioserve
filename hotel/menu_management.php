...
<body>
        ...
        <main class="main-content">
            <div
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-outline-primary-green rounded-pill px-4" data-bs-toggle="modal" data-bs-target="#importExcelModal">
    ...
    <div class="modal fade" id="importExcelModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="process_menu.php?action=import_csv" method="POST" enctype="multipart/form-data" class="modal-content">
                <?php echo csrfField(); ?>
                ...
                <div class="modal-body">
                    <p class="text-muted small">Prepare your menu in an Excel file and save it as <strong>CSV (Comma Delimited)</strong>. Use these columns:</p>
