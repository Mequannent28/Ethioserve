    ...
    <div class="position-sticky pt-3">
        <div class="px-4 mb-4 text-center">
            ...
            <p class="text-white-50 small mb-0">
                <?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Broker'); ?>
            </p>
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'referrals.php' ? 'active' : ''; ?>"
                    href="referrals.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../customer/index.php">
                    <i class="fas fa-store"></i> Browse Platform
                </a>
            </li>
