    ...
    <div class="position-sticky pt-3">
        <div class="px-4 mb-4 text-center">
            ...
            <p class="text-white-50 small mb-0">
                <?php echo htmlspecialchars($_SESSION['full_name'] ?? 'Taxi Operator'); ?>
            </p>
            <small class="text-white-50"><i class="fas fa-taxi me-1"></i>Taxi Panel</small>
        </div>
        <ul class="nav flex-column">
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'rides.php' ? 'active' : ''; ?>"
                    href="rides.php">
                    <i class="fas fa-route"></i> Rides
                </a>
            </li>
            <li class="nav-item">
